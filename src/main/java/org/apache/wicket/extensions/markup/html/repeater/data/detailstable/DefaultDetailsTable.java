 ...
 * headers, and no-records-found toolbars to a standard {@link DataTable}.
 * <p>
...
public class DefaultDetailsTable<T, S> extends DetailsTable<T, S> {
     ...
     */
    public DefaultDetailsTable(final String id, List<IColumn<T, S>> columns,
